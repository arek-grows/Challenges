...
# establish each position of the letters in the first list. Return a string from the unscrambled letters (that
# made-up the word). Examples
#
# word_builder(["g", "e", "o"], [1, 0, 2]) ➞ "ego"
#
# word_builder(["e", "t", "s", "t"], [3, 0, 2, 1]) ➞ "test"
#
# word_builder(['e', 'i', 'y', 'n', 'r', 'e', 'g', 'n', '.', 'p', 'b'], [10, 0, 6, 1, 3, 7, 5, 4, 8, 9,
# 2]) ➞ "beginner.py"
#
# Notes
#
...
def word_builder(scrambled: list[str], corrected_indexes: list[int]) -> str:
    unscrambled = ''
    for i in corrected_indexes:
        unscrambled += scrambled[i]
    return unscrambled  # Put your code here!!!
