# Challenge 209 - Multiplication Table
#
# Your task, is to create an N x N multiplication table, of size n.
#
...
def multiplication_table(n: int) -> list[list[int]]:
    rows, cols = n, n
    table = [[i for i in range(cols)] for j in range(rows)]
    for x in range(n):
        table[x][0] = x + 1
        table[0][x] = x + 1
    for x in range(1, n):
    ...
    return table  # Put your code here!!!
